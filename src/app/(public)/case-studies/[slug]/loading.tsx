    ...
    <>
      ...
      >
        <div className="max-w-[880px] mx-auto">
          <Bone className="h-3.5 w-28 mb-8" />
          <Bone className="h-3 w-20 mb-3.5" />
          <Bone className="h-10 w-full max-w-[600px] mb-2" />
          <Bone className="h-10 w-3/4 max-w-[450px] mb-4" />
      ...
      <section className="px-5 sm:px-12 py-12">
        <div className="max-w-[880px] mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              <Bone className="h-9 w-24 mx-auto mb-2" />
      ...
      <section className="px-5 sm:px-12 py-10">
        <div className="max-w-[720px] mx-auto">
          ...
          <Bone className="h-3.5 w-2/3 mb-12" />
